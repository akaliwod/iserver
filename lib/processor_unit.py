...
class ProcessorUnit(IntersightCommon):
    ...
    def get_processor_units_info(self):
        ...
        for processor_unit in processor_units:
            processor_unit_info = {}
            for key in ['Architecture', 'Model', 'NumCores', 'NumCoresEnabled', 'NumThreads', 'OperState', 'Presence', 'ProcessorId', 'SocketDesignation', 'Speed', 'Stepping', 'Vendor']:
                processor_unit_info[key] = processor_unit[key]
            processor_units_info.append(processor_unit_info)
