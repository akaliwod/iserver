...
[2022-12-08 23:09:06.909924]	[computes_info.get]	Get servers settings: {
    "rack": true,
    "blade": true,
...
[2022-12-08 23:09:06.911878]	[computes_info.get]	Get servers match rules: {
    "name": "comp-1-p2b-eu-spdc-WZP23400AJW",
    "ip": [],
    "serials": [],
    "model": "",
...
[2022-12-08 23:09:11.997957]	[computes_info.get]	All 103 servers base information in 5075 ms
[2022-12-08 23:09:12.000100]	[computes_info.get]	Base filter 1 servers in 1 ms
[2022-12-08 23:09:16.539371]	[compute_info.get]	{
...
[2022-12-08 23:09:16.542600]	[computes_info.get_server_info]	Thread result: 5fdf9c016176752d35e44795
[2022-12-08 23:09:16.605587]	[computes_info.get]	Selected 1 servers with requested details in 4604 ms
[2022-12-08 23:09:16.607119]	[computes_info.get]	Total time 9697 ms
[2022-12-08 23:09:16.613813]	[compute_info.get]	{
    "AccountMoid": "5be4b2ce67626c6d661ca38d",
    "Adapters": [
        {
            "ClassId": "mo.MoRef",
...
2022-12-08 23:09:10.216076	True	3238	93	isctl get compute rackunit   -o json --top 100
2022-12-08 23:09:11.995964	True	1773	10	isctl get compute blade   -o json --top 100
2022-12-08 23:09:18.270510	True	1655	1	isctl get asset deviceregistration  moid 5fdf9be76f72612d300a8d81 -o json
2022-12-08 23:09:20.543002	True	2267	42	isctl get workflow workflowinfo --filter "CreateTime gt 2022-12-01T23:09:18.000Z"  -o json --top 100
2022-12-08 23:09:22.134091	True	1570	1	isctl get equipment locatorled --filter "RegisteredDevice/Moid eq '5fdf9be76f72612d300a8d81'"  -o json --top 100
2022-12-08 23:09:23.753606	True	1594	10	isctl get firmware runningfirmware --filter "RegisteredDevice/Moid eq '5fdf9be76f72612d300a8d81'"  -o json --top 100
```
